...
if (!class_exists('g5plusFramework_Shortcode_Feature')) {
	class g5plusFramework_Shortcode_Feature
	{
		...
		function feature_shortcode($atts)
		{
            ...
            ob_start();?>
            <div class="darna-feature <?php echo esc_attr($layout_style) ?> <?php echo esc_attr($g5plus_animation) ?>" <?php echo g5plusFramework_Shortcodes::g5plus_get_style_animation($duration,$delay); ?>>
                ...
                <div class="darna-feature-content">
                    ...
                    <?php if($a_title !=''):?>
                    <a class="darna-button style4 size-xs" target="<?php echo esc_attr($a_target) ?>" href="<?php echo esc_url($a_href); ?>"><?php echo esc_attr($a_title); ?></a>
                    <?php endif;?>
                </div>
            </div>
            <?php
