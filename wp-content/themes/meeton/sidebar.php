<div class="blog-box clearfix">
    ...
    <div class="meta">
        ...
        <span><a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta('ID') )); ?>" title="<?php the_author_meta( 'display_name' ); ?>"><?php esc_html_e('by : ' , 'meeton'); ?><?php the_author(); ?></a></span>
        <span><?php esc_html_e('in : ' , 'meeton'); ?><?php the_category(', '); ?></span>
    ...
    <div class="desc">
        <p> <?php the_excerpt(); ?> </p>
        <a href="<?php echo esc_url(get_permalink(get_the_id())); ?>" class="readmore" title="<?php the_title_attribute(); ?>"><?php esc_html_e('Read More' , 'meeton'); ?><i class="icon-angle-double-right"></i></a>
    </div><!-- end desc -->
</div><!-- end blog-wrap -->                   
