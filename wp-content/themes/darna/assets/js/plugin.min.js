 ...
 */
!function(i){"use strict";i.fn.equalHeight=function(){var e=[];return i.each(this,function(t,n){var r,o=i(n),s="border-box"==o.css("box-sizing")||"border-box"==o.css("-moz-box-sizing");r=s?o.innerHeight():o.height(),e.push(r)}),this.height(Math.max.apply(window,e)),this},i.fn.equalHeightGrid=function(e){var t=this;t.css("height","auto");for(var n=0;n<t.length;n++)if(n%e===0){for(var r=i(t[n]),o=1;e>o;o++)r=r.add(t[n+o]);r.equalHeight()}return this},i.fn.detectGridColumns=function(){var e=0,t=0;return this.each(function(n,r){var o=i(r).offset().top;return 0!==e&&o!=e?!1:(t++,void(e=o))}),t},i.fn.responsiveEqualHeightGrid=function(){function e(){var i=t.detectGridColumns();t.equalHeightGrid(i)}var t=this;return i(window).bind("resize load",e),e(),this}}(jQuery),jQuery(document).ready(function(){jQuery(function(i){i('[class*="vc_col-"]',".column-equal-height").responsiveEqualHeightGrid()})});
/*!
