...
$delay=$duration=$output = $el_class = $image = $img_size = $img_link = $img_link_target = $img_link_large = $title = $alignment = $css_animation = $css = '';
$exact_size = false;
...
$output .= "\n\t" . '<div class="' . $css_class . g5plus_get_css_animation($css_animation).'" '.g5plus_get_style_animation($duration,$delay).'>';
