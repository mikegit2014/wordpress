            ...
            if ($search && count($search->post) > 0) {
                ...
                foreach ( $search->posts as $post ) {
                    if ($count == $posts_per_page) {
                        $newdata[] = array(
                            'id'        => -2,
                            'title'     => '<a href="' . site_url() .'?s=' . $keyword . '"><i class="fa fa-mail-forward"></i> ' . __('View More','g5plus-framework') . '</a>',
                            'guid'      => '',
                            'date'      => null,
                        );
                ...
                $newdata[] = array(
                    'id'        => -1,
                    'title'     => __('Sorry, but nothing matched your search terms. Please try again with different keywords.','g5plus-framework'),
                    'guid'      => '',
                    'date'      => null,
                );
            }
