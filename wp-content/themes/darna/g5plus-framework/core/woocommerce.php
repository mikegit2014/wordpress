...
if ( class_exists( 'WooCommerce' ) ) {
        ...
        function g5plus_woocommerce_add_custom_general_fields() {
            ...
            woocommerce_wp_checkbox(
                array(
                    ...
                    'label' => __('Product New', 'g5plus-framework')
                )
            );
            echo '</div>';
        }
    ...
    if (!function_exists('g5plus_button_continue_shopping')) {
        function g5plus_button_continue_shopping () {
            ...
            ?>
            <a href="<?php echo esc_url($continue_shopping); ?>" class="continue-shopping button"><?php _e( 'Continue shopping', 'g5plus-framework' ); ?></a>
            <?php
        }
    }
